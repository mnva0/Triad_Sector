shipyard-grid-save-limit-message = You have too many {$id} on this ship! You may only have {$max} at most on this ship.

shipyard-grid-save-limit-MilitaryStash = military stashes
